...
">
   ...
   <!--    <div id="get-started" tabindex="-1" role="dialog" aria-labelledby="Login" aria-hidden="true" class="modal fade">
      ...
      <!-- *** SIGNUP MODAL END ***-->
      <body id="intro" class="text-intro">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
...
Dites moi seulement à quelle adresse je dois vous l'envoyer ! -->
              ...
              <h3 class="weight-300">Soit rémunéré en intégrant nos widgets, liens sur ton site, facebook...</h3>
              <!-- <h3 class="weight-300"> Si tu as des questions, c'est sur affiliat !!</h3> -->
      ...
      <a class="btn btn-primary btn-lg btn-block" href="https://aventour.typeform.com/to/UpfNUO" target="_blank">Compte affiliation</a>
