...
<html>
  <head>
    ...
    <title>Lien widget affiliation</title>
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/fr_FR/sdk.js#xfbml=1&version=v2.8&appId=731663666968594";
    ...
    <div id="all">
      ...
      <section id="intro" class="text-intro">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h3>A copier sur ton site, ton facebook,...</h3>
              <p>(Ton identifiant est: <?php echo $_GET['idaff'];?>)</p>
              <!-- <h3>Confirmation</h3> -->
...
Dites moi seulement à quelle adresse je dois vous l'envoyer ! -->
          ...
          <div class="row">
            <div class="col-md-12"> 
              ...
              $lien="http://www.aventour.net/?idaff=$_GET[idaff]";?>
          <h4><p> <?php echo $lien; ?></p></h4>
          <hr><hr>

                    <h4><b><p>Quelques exemples</p></b></h4>
                    <hr><hr>

                    <div class="jumbotron">
                      
                    <h4 class="">
                    <a href="<?php echo $lien; ?>" target="_blank"><?php echo $lien; ?></a>
                    <br><br>
                    <a href="<?php echo $lien; ?>" target="_blank">Reserver tour sur Aventour.net</a>
                    </h4>
                  
           <div class="highlight"><pre><code class="language-html" data-lang="html">
            <span class="nt">&lt;a</span><span class="na"> href=</span><span class="s">"<?php echo $lien; ?>"</span> <span class="na">target=</span><span class="s">"_blank"</span> <span class="nt">&gt;</span><?php echo $lien; ?><span class="nt">&lt;/a&gt;</span>
            <span class="nt">&lt;a</span><span class="na"> href=</span><span class="s">"<?php echo $lien; ?>"</span> <span class="na">target=</span><span class="s">"_blank"</span> <span class="nt">&gt;</span>Reserver tour sur Aventour.net<span class="nt">&lt;/a&gt;</span>
</code></pre></div>
</div>

 <div class="jumbotron">
  <h4>Avec Bootstrap</h4>
                      
                    <h4 class="">
                     <a class="btn btn-primary" target="_blank" href="http://www.aventour.net/?idaff=<?php echo $_GET['idaff'];?>">Go Aventour.net</a>
         
          <a class="btn btn-success" target="_blank" href="http://www.aventour.net/?idaff=<?php echo $_GET['idaff'];?>">Go Aventour.net</a>
          <a class="btn btn-info" target="_blank" href="http://www.aventour.net/?idaff=<?php echo $_GET['idaff'];?>">Go Aventour.net</a>
          <a class="btn btn-warning" target="_blank" href="http://www.aventour.net/?idaff=<?php echo $_GET['idaff'];?>">Go Aventour.net</a>
          <a class="btn btn-danger" target="_blank" href="http://www.aventour.net/?idaff=<?php echo $_GET['idaff'];?>">Go Aventour.net</a>
                    </h4>
          ...
          <span class="nt">&lt;a</span> <span class="na">class=</span><span class="s">"btn btn-primary"</span> <span class="na">href=</span><span class="s">"<?php echo $lien; ?>"</span> <span class="na">target=</span><span class="s">"_blank"</span> <span class="nt">&gt;</span>Go Aventour.net<span class="nt">&lt;/a&gt;</span>
          <span class="nt">&lt;a</span> <span class="na">class=</span><span class="s">"btn btn-success"</span> <span class="na">href=</span><span class="s">"<?php echo $lien; ?>"</span> <span class="na">target=</span><span class="s">"_blank"</span> <span class="nt">&gt;</span>Go Aventour.net<span class="nt">&lt;/a&gt;</span>
          <span class="nt">&lt;a</span> <span class="na">class=</span><span class="s">"btn btn-info"</span> <span class="na">href=</span><span class="s">"<?php echo $lien; ?>"</span> <span class="na">target=</span><span class="s">"_blank"</span> <span class="nt">&gt;</span>Go Aventour.net<span class="nt">&lt;/a&gt;</span>
          <span class="nt">&lt;a</span> <span class="na">class=</span><span class="s">"btn btn-warning"</span> <span class="na">href=</span><span class="s">"<?php echo $lien; ?>"</span> <span class="na">target=</span><span class="s">"_blank"</span> <span class="nt">&gt;</span>Go Aventour.net<span class="nt">&lt;/a&gt;</span>
          <span class="nt">&lt;a</span> <span class="na">class=</span><span class="s">"btn btn-danger"</span> <span class="na">href=</span><span class="s">"<?php echo $lien; ?>"</span> <span class="na">target=</span><span class="s">"_blank"</span> <span class="nt">&gt;</span>Go Aventour.net<span class="nt">&lt;/a&gt;</span>

</code></pre></div>
</div>

<div class="jumbotron">
  <h4>Si tu as des questions, ou si par exemple tu ne sais pas comment inserer ces liens sur ton site, facebook... C'est par ici!</h4>

  <div class="fb-comments" data-href="http://www.aventour.net/stripe/lienwidget.php" data-colorscheme="dark" data-numposts="10"></div>
</div>
