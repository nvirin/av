...
<div class="form-group">
  ...
  <input class="form-control" placeholder=<?php  if(!empty($mapresentation)){echo '\'Editer ma présentation...\'';}else{echo '\'Une petite présentation sur moi...\'';} ?> value='' name="presentation" id="presentation" rows="2"></input>
