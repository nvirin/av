...
$autrelangues=$_POST['autrelangues'];
...
// $situation=$_POST['situation'];
// $independant=$_POST['independant'];
smtpmailer('vnicolas060@gmail.com', 'nicolas@aventour.net', 'AVENTOUR.NET', 'Candidature: '.$mail. ' '.$prenom.' '.$nom, '<br> Prenom: '.$prenom.'<br>Nom: '.$nom.'<br>Mail: '.$mail.'<br>Telephone: '.$phone.
  '<br>Age: '.$age.'<br><br><br>Français: '.$francais.'<br>Anglais: '.$anglais.'<br>Autres Langues: '.$autrelangues.'<br><br><br>Situation actuelle: '.$situation.'<br>Independant? '.$independant.'<br><br><br>Qui es tu: <br>'.$description);
header('Location: cometoyou.html');
