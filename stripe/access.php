...
smtpmailer('vnicolas054@gmail.com', 'nicolas@aventour.net', 'Nicolas d\'aventour.net', 'Affiliation: '.$_POST['email'].'  '.$_POST['website'], '<u>email</u>: <b>'.$_POST['email'].'</b><br><br><u>website</u>: <b>'.$_POST['website'].'</b><br><br><u>prenom & nom</u>: <b>'.$_POST["fname"].' '.$_POST["lname"].'</b><br><br><u>autres support</u>:<br><b>'.$_POST["support"].'</b>'); 
