 ...
 * @access public
 */
final class Acmephoto_Customize {
	...
	public function sections( $manager ) {
		...
		$manager->register_section_type( 'Acmephoto_Customize_Section_Pro' );

		// Register sections.
		$manager->add_section(
			new Acmephoto_Customize_Section_Pro(
				$manager,
				'acmephoto',
				array(
					'title'    => esc_html__( 'AcmePhotoPro', 'acmephoto' ),
					'pro_text' => esc_html__( 'Upgrade To Pro',         'acmephoto' ),
					'pro_url'  => 'https://www.acmethemes.com/themes/acmephotopro/',
					'priority'          => 0
				)
			)
		);
