...
class C37LPFormGump
{
     ...
     * @return string
     */
    public function c37GumpToString()
    {
     ...
     * @throws Exception
     */
    public static function gump_add_filter($rule, $callback)
    {
        $method = 'filter_'.$rule;
    ...
    public function get_readable_errors($convert_to_string = false, $field_class = 'gump-field', $error_class = 'gump-error-message')
    {
        ...
        foreach ($this->errors as $e) {
            $field = $e['field'];//ucwords(str_replace($this->fieldCharsToRemove, chr(32), $e['field']));
            $param = $e['param'];
            ...
            switch ($e['rule']) {
                case 'mismatch' :
                    $resp[] = array('name'=>$field, 'message'=>"There is no validation rule for <span class=\"$field_class\">$field</span>");
                    break;
                case 'validate_required' :
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field is required");
                    break;
                case 'validate_valid_email':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field is required to be a valid email address");
                    break;
                case 'validate_max_len':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field needs to be $param or shorter in length");
                    break;
                case 'validate_min_len':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field needs to be $param or longer in length");
                    break;
                case 'validate_exact_len':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field needs to be exactly $param characters in length");
                    break;
                case 'validate_alpha':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field may only contain alpha characters(a-z)");
                    break;
                case 'validate_alpha_numeric':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field may only contain alpha-numeric characters");
                    break;
                case 'validate_alpha_dash':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field may only contain alpha characters &amp; dashes");
                    break;
                case 'validate_numeric':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field may only contain numeric characters");
                    break;
                case 'validate_integer':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field may only contain a numeric value");
                    break;
                case 'validate_boolean':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field may only contain a true or false value");
                    break;
                case 'validate_float':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field may only contain a float value");
                    break;
                case 'validate_valid_url':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field is required to be a valid URL");
                    break;
                case 'validate_url_exists':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> URL does not exist");
                    break;
                case 'validate_valid_ip':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field needs to contain a valid IP address");
                    break;
                case 'validate_valid_cc':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field needs to contain a valid credit card number");
                    break;
                case 'validate_valid_name':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field needs to contain a valid human name");
                    break;
                case 'validate_contains':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field needs to contain one of these values: ".implode(', ', $param));
                    break;
                case 'validate_contains_list':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field needs to contain a value from its drop down list");
                    break;
                case 'validate_doesnt_contain_list':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field contains a value that is not accepted");
                    break;
                case 'validate_street_address':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field needs to be a valid street address");
                    break;
                case 'validate_date':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field needs to be a valid date");
                    break;
                case 'validate_min_numeric':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field needs to be a numeric value, equal to, or higher than $param");
                    break;
                case 'validate_max_numeric':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field needs to be a numeric value, equal to, or lower than $param");
                    break;
                case 'validate_starts':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field needs to start with $param");
                    break;
                case 'validate_extension':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field can have the following extensions $param");
                    break;
                case 'validate_required_file':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field is required");
                    break;
                case 'validate_equalsfield':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field does not equal $param field");
                    break;
                case 'validate_min_age':
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field needs to have an age greater than or equal to $param");
                    break;
                default:
                    $resp[] = array('name'=>$field, 'message'=>"The <span class=\"$field_class\">$field</span> field is invalid");
            }
        }
