 ...
 */
require_once( 'hype-social-buffer.php' );
...
if ( ! class_exists( 'HsbAdmin' ) ) {
	...
	class HsbAdmin extends HsbCore {
		...
		public function hsb_admin_actions() {
			add_menu_page( __( 'HYPE Social Buffer Settings', 'HYPESocialBuffer' ), __( 'HYPE Social Buffer', 'HYPESocialBuffer' ), 'manage_options', 'HYPESocialBuffer', array(
				$this,
				"hsb_admin"
			) );
