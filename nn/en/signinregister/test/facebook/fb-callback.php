...
if (isset($accessToken)) {
  ...
  try {
    ...
    if ($e->getCode() == 190) {
      ...
      $helper = $fb->getRedirectLoginHelper();
      $loginUrl = $helper->getLoginUrl('http://www.aventour.net/en/signinregister/', $permissions);
  ...
  try {
    ...
    header("Location: http://aventour.net/en/signinregister/index.php");
    exit;
  } catch(Facebook\Exceptions\FacebookSDKException $e) {
    // When validation fails or other local issues
    echo 'Facebook SDK returned an error: ' . $e->getMessage();
...
$mymessagepourleguide='<p>Hi '.$prenom.'!<br><br>

I\'m Nicolas Virin Founder of aventour.net <br>
Welcome to this adventure! ^^<br><br>

If you have questions, suggestions or just want to chat<br>
you can do it on nicolas@aventour.net<br>
or just responding his email <br><br>

We currently work on the improvment of the website<br>
and design Android and Iphone app<br><br>

To finish, if you want to follow us :<br><br>
...
Can I ask you questions? What are you waiting for aventour.net and How would you improve this one?<br><br>

See you,<br><br>

Nicolas<br>
Founder of aventour.net
<br><a href="http://www.aventour.net/en/" title="">http://www.aventour.net</a></p>';

smtpmailer( $mail, 'nicolas@aventour.net', 'Nicolas Virin Founder of AVENTOUR.NET', 'Welcome to aventour.net', $mymessagepourleguide); 
smtpmailer('vnicolas054@gmail.com', 'nicolas@aventour.net', 'Nicolas Virin Founder of AVENTOUR.NET', 'Welcome to aventour.net: '.$prenom.' '.$nom.' '.$mail.' '.$nombrefb, 'nouveauinscris <br>Prénom: '.$prenom.'<br>Nom: '.$nom.'<br>mail '.$mail.'<br>amisFB: '.$nombrefb); 

smtpmailer('vnicolas054@gmail.com', 'nicolas@aventour.net', 'Nicolas Virin Founder of AVENTOUR.NET', 'Welcome to aventour.net', $mymessagepourleguide); 
...
$path=$_SERVER['DOCUMENT_ROOT'].'/users/'.$mailhex;
  ...
  $helper = $fb->getRedirectLoginHelper();
  $loginUrl = $helper->getLoginUrl('http://www.aventour.net/en/');
  echo "<script>window.top.location.href='".$loginUrl."'</script>";
}
