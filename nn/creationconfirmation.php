                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                       <!-- <div class="modal-header" style="background-color: rgb(1, 2, 21);">
                                            ...
                                            <h4 class="modal-title" id="project-13-label"></h4>
                                        </div> -->
                                         <div class="modal-body" style="background-color: rgb(1, 2, 21);">
                                            <h3>Ajouter des dates supplémentaires?</h3>
                                             ...
                                             <div class="row">
                                                <div class="col-md-12"> 
                                                   ...
                                                   <!--  //formulaire avec oui ou non -->
                                                     <div class="form-group">
                                        <div class="row">
                                           
                                            <!-- <a href="" class="btn" data-toggle="modal" data-target="#project-13" id="monConectInscris">Continuer</a> -->
                                               
                                                <div class="col-md-6">
                                                   <!-- oui -->

                                                       <input type="submit" name="go-submit" id="login-submit" tabindex="4" class="form-control btn btn-login" value="Oui">
                                                      ...
                                                      <!-- non -->
                                                       ...
                                                       <input type="submit" name="go-submit" id="login-submit" tabindex="4" class="form-control btn btn-login" value="Non">
                            ...
                            <!-- Modal end -->
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <a href="" class="form-control btn btn-login" data-toggle="modal" data-target="#project-13" id="monConectInscris">Continuer</a>
