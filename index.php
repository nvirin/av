				...
				<div class="col-md-3 col-sm-3 col-xs-1">
					...
					<div class="header-left clearfix">
						...
						<div class="logo smooth-scroll"> 
							<a href="/"><img id="logo" src="images/logo.png" alt="AvenTour activité touristique avec l'habitant A la Reunion et Paris"></a>
...
<div class="col-md-3">
											<li class="active"><a href="blog" class="btn" id="monConectInscris">Blog</a></li>
										</div>
...
<div id="banner" class="banner">
	...
	<div class="video-container">
		<img src="images/bg/2.jpg" class="img-responsive" alt="Activité touristique avec l'habitant- Pars à l'aventure et visite l'ile de la Réunion avec ses locaux ou découvre Paris... #Tourisme #Ile de La Réunion #Paris #découverte #aventure #authenticité #visitetouristique #aventour" style="/* width: 100%; *//* height: 100%; */display: block;width: 100vw;height: 100vh;object-fit: cover;">
...
<!-- 
	...
	<button type="submit" class="btn btn-default btn-primary">J'y vais !</button>
