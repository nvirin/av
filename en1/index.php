...
if($_GET['coucou']!='coucou'){
	 //die('<html><meta http-equiv="Content-type" content="text/html; charset=utf-8" /><div class="col-md-12 center"><h1 style="text-align:center"><br><br>Mise à jour en cours... Je reviens vers 21h<br>Sur ce Joyeuse Pâques ;)</h1></div></html');
}
...
<head>
	<meta charset="utf-8">
	<title>Tourism activity with local: Paris, London, Reunion Island... - AvenTour</title>

	<META NAME="TITLE" CONTENT="AvenTour">
<META NAME="DESCRIPTION" CONTENT="AvenTour, tourism activities with locals">
<META NAME="KEYWORDS" CONTENT="tourism activities, locals, adventures, traveling, what to do in Paris, what to do in London">
...
if(isset($_SESSION['lang'])){
	...
	if($_SESSION['lang']=='fr'){
       ...
       if(language=="fr"){
      document.location.href="http://www.aventour.net"
      }
...
// var sessionValue = "<?php echo $x; ?>";

// alert("You have your browser language set to " + sessionValue );
// if(sessionValue=='fr'){

// }else if(sessionValue=='en'){
				...
				<div class="col-md-3 col-sm-3 col-xs-1">
					...
					<div class="header-left clearfix">
						...
						<div class="logo smooth-scroll">
							<a href="#banner"><img id="logo" src="images/logo.png" alt="AvenTour logo"></a>
						</div> 
						...
						<div class="main-navigation">
							...
							<nav class="navbar navbar-default" role="navigation">
								...
								<div class="collapse navbar-collapse scrollspy smooth-scroll" id="navbar-collapse-1" style="padding-top: 3px;">
									...
									<li><a href="" class="btn" data-toggle="modal" data-target="#project-11" id="monCQuoi">Create Tour!
	...
	<div class="banner-caption zindexdeux" id="banner-caption">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-12">
					<h1 class="text-center">Get this Aven<span>Tour</span> with me</h1>
...
<!-- 
			...
			<div class="col-md-3 col-xs-12">
				...
				<!-- <a href="#"> -->
					...
					<button type="submit" class="btn btn-default btn-primary">Discover it!</button>
		...
		<div class="container" id="mail">
			<div class="row">
				...
				<div class="col-md-4 text-center">
					...
					<!-- <hr class="primary"> -->
					<img src="images/martine.png" alt="notice tourism tour in Paris" class="img-responsive center-block"> 
					
				</div>
				<div class="col-md-4 text-center">
				<img src="images/melanie.png" alt="notice tourism activity in London" class="img-responsive center-block"> 
					
				</div>

				<div class="col-md-4 text-center">
					
					<img src="images/jean.png" alt="notice tourism activity in Reunion Island" class="img-responsive center-block"> 
					<p></p>
				</div>
...
<!-- <div class="section clearfix object-non-visible" data-animation-effect="fadeIn" style="padding: 0px;"> -->
    ...
    z-index: 3;">
					<h2 class="section-heading">Aventour: Paris, the city of lights!</h2>
					<hr class="primary">
				...
				<div class="col-md-6 text-center">
					<h2 class="section-heading">Aventour: Reunion Island, the intense island!</h2>
					<hr class="primary">
					<iframe style="
								...
								<div class="modal-dialog modal-lg">
									<div class="modal-content">
										<div class="modal-header">
											...
											<h4 class="modal-title" id="project-10-label">AvenTour : What to do in Paris? What to do in Reunion Island? What to do in London? Tourism activity with local </h4>
										</div>
