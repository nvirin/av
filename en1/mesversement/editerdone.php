...
//header('Location: http://aventour.io/myindexdev.php');
  die('<html><meta http-equiv="Content-type" content="text/html; charset=utf-8" /><div class="col-md-12 center"><h1 style="text-align:center"><br><br>Edition done <br>'.$erreur.'<br><a href="http://aventour.net/en/">Home</a></h1></div></html');
...
//echo'coucou0 '.$mailstring;
 ...
 ?>
    ...
    <a href="http://aventour.net/en/">Home</a>
    </h1>
    </div>
    </html>
