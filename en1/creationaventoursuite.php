...
if(!((isset($_SESSION['myid'])&&file_exists($_SERVER['DOCUMENT_ROOT'].'users/'.$_SESSION['myid'])))){
  ...
  die('<html><meta http-equiv="Content-type" content="text/html; charset=utf-8" /><div class="col-md-12 center"><h1 style="text-align:center"><br><br>Hey, you have to sign in before creating your activity =/ <br><a href="signinregister/">Sign in</a></h1></div></html');
...
<title>Step 1 create your tourism activity - AvenTour</title>

    <META NAME="TITLE" CONTENT="AvenTour">
<META NAME="DESCRIPTION" CONTENT="AvenTour, creation of activity step 1">
...
<div class="form-group">
  <label class="col-md-4 control-label" >Title </label> 
    ...
    <div class="input-group">
  <!-- <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span> -->
  <input name="title" id="title" placeholder="Mon super title" class="form-control"  type="text" value=<?php  echo "\"".$_SESSION['title']."\"";?> required>
    </div>
  </div>
</div>
...
<!-- Text input-->
       <div class="form-group">
  <label class="col-md-4 control-label">Meeting point</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <!-- <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span> -->
         <span class="input-group-addon"><i class="glyphicon glyphicon-map-marker"></i></span>
  ...
  <!-- <div id="locationField"> -->
      <input id="autocomplete" name="locationDeparture" class="form-control" value=<?php  echo "\"".$_SESSION['locationDeparture']."\"";?> placeholder="Meeting point (address)"
...
<div class="form-group">
 ...
 <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
  ...
  <input type="text" class="form-control"  placeholder="When ?" id="datepicker-13" name="datepicker" value=<?php  echo "\"".$_SESSION['datepicker']."\"";?> required >
    </div>
  </div>
</div>
<br>
...
<div class="form-group">
  <label class="col-md-4 control-label">What time</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group  clockpicker" data-placement="right" data-align="top" data-autoclose="true">
...
<div class="form-group">
  <label class="col-md-4 control-label">Duration (approximate)</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span> 
 <!--  <input name="phone" placeholder="+33615321254" class="form-control" type="tel" required> -->
...
<div class="form-group">
<div class="col-xs-12">
                                <h3>Number of people (tourists)</h3>
                            </div>
...
<div class="form-group">
<div class="col-xs-12">
                                <h3>3 tags characterizing your activity</h3>
                            </div>
  <label class="col-md-4 control-label">Tags</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-tags"></i></span>
  <input type="text" name="tag1" id="title" tabindex="1" class="form-control" placeholder="Ex: Ballad" value=<?php  echo "\"".$_SESSION['tag1']."\"";?> required> 
   <input type="text" name="tag2" id="title" tabindex="1" class="form-control" placeholder="Ex: Tasting" value=<?php  echo "\"".$_SESSION['tag2']."\"";?> required>
    <input type="text" name="tag3" id="title" tabindex="1" class="form-control" placeholder="Ex: History" value=<?php  echo "\"".$_SESSION['tag3']."\"";?> required>
    </div>
  </div>
</div>  
...
<div class="form-group">
  <label class="col-md-4 control-label"></label>
  <div class="col-md-4">
    <button type="submit" name="submit" class="btn btn-warning" >next <span class="glyphicon glyphicon-send"></span></button>
