...
<form method="post" id="signup" class="validate formee" action="subscribe.php" target="_blank">							
								...
								<!-- Form Name -->
								<legend>Guide "Que faire à La Réunion- à Paris" (Rédaction en cours)</legend> 
								<h5 class="text-muted">Dis moi simplement à quelle adresse je dois vous l'envoyer!</h5> 
			...
			<div class="row">
								...
								<div class="col-md-12 form-group mc-field-group">
									...
									<div class="col-md-4 inputGroupContainer">
										<div class="input-group mc_embed_signup_scroll">
											...
											<input required type="email" value="" placeholder="nicolas@aventour.net" name="email" class="required email form-control" id="email">
										</div>
								...
								<div class="col-md-12 form-group clear" id="mce-responses" >
									...
									<div class="col-md-4">
										...
										<button type="submit" value="Subscribe" class="btn btn-primary clear" name="subscribe" id="mc-embedded-subscribe">Recevoir le guide<span class="glyphicon glyphicon-send"></span></button>
									</div>
								</div>
