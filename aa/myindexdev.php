						...
						<div class="main-navigation animated">
							...
							<nav class="navbar navbar-default" role="navigation">
								...
								<div class="collapse navbar-collapse scrollspy smooth-scroll" id="navbar-collapse-1" style="padding-top: 3px;">
									...
									<div class="col-md-4">
										<li><a href="" class="btn" data-toggle="modal" data-target="#project-11" id="monCQuoi">Créer Tour</i>
</a></li>
			...
			<div class="col-md-7 col-md-offset-2 col-xs-12">
				<div class="form-group">
					...
					<select id="location" name="location" class="form-control">
						<option value="paris">Paris (Lancement 2016!)</option>
						<option value="reunion">La Réunion (Lancement 2016!)</option>
...
<div class="section clearfix object-non-visible" data-animation-effect="fadeIn" style="padding: 0px;">
    ...
    z-index: 3;">
					...
					<!-- <iframe style="
    z-index: 30;" id="videoReunion0" src="https://www.youtube.com/embed/97IYfZ8dx7o" frameborder="0" allowfullscreen controls="0" volume="0"></iframe> -->
...
// $(function() {
//     $('#videoReunion').waypoint(function() {
//         //$('#P2').playYTP();
