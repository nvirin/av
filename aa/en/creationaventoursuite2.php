...
<head>
    <meta charset="utf-8">
    <title>Step 2 create your tourism activity - AvenTour</title>

    <META NAME="TITLE" CONTENT="AvenTour">
<META NAME="DESCRIPTION" CONTENT="AvenTour, creation of activity step 2">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                   <!--  <li>
                    ...
                    <li> 
                        <a href="http://aventour.net/en/creationaventoursuite.php">Create your tour</a>
                    </li>
                    <li style="
    margin-right: 10px;
    margin-top: 5px;
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form id="login-form" action="creationconfirmation.php" method="post" role="form" style="display: block;">
                                    ...
                                    <h4>Minimal advising price: <?php echo $prix." €" ?></h4>
                                    <!-- <br><h5>Ce prix a été calculé en fonction des valeurs que vous avez entrée.</h5> -->
                                    <h5>Do not hesitate to reajust it!</h5>
                                        ...
                                        <div class="col-md-12 jumbotron">
                                          <h3>Price for a group of <?php echo $minimum; ?> to <?php echo $maximum; ?> person </h3>
                                       <input type="text" name="prix" id="title" class="form-control" tabindex="1" data-slider="true" value=<?php echo "\"".$prix."\"" ?> data-slider-highlight="true" data-slider-theme="volume" data-slider-range="5,200">
                                        </div>
                                         <div class="col-md-12">
                                         <h6 style="font-size: 5em;">+</h6>
                                         </div>
                                        <div class="col-md-12 jumbotron">
                                        <h3>Price by additional person</h3>
                                       <input type="text" name="sup" id="title" class="form-control" tabindex="1" data-slider="true" value="5" data-slider-highlight="true" data-slider-theme="volume" data-slider-range="0,100">
                                       </div>
                                       <script>
  $("[data-slider]")
    .each(function () {
