...
<!-- left column -->
      <div class="form-group">
        <div class="text-center">
          ...
          <?php 
                 $couverture='http:/aventour.net/users/'.$_SESSION['myid'].'/couverture.jpg';
          ...
          <h6>Change your cover picture (.jpg and 5mo max)</h6>
...
<div class="form-group">
  ...
  <select class="form-control" name="lv1">
		...
		<option value="Japonais">Japenese</option>
...
<!-- Text input-->
       <div class="form-group">
  <label class="col-md-4 control-label">Second language</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
...
<!-- Text input-->
       <div class="form-group">
  <label class="col-md-4 control-label">Third language</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <!-- <input name="email" placeholder="E-Mail" class="form-control"  type="text" data-bv-verbose="false" required> -->
...
<div class="form-group">
  ...
  <div class='col-md-12'><p><?php  if(!empty($mapresentation)){echo '<u>My current presentation:</u><br>'.$mapresentation;} ?></p></div> 
  ...
  <input class="form-control" placeholder=<?php  if(!empty($mapresentation)){echo '\'Edit my presentation...\'';}else{echo '\'A presentation about me...\'';} ?> value='' name="presentation" id="presentation" rows="2"></input>
