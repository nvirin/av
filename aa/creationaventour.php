                    ...
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                <h3>Création d'un tour touristique: AvenTour.net</h3>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <form id="login-form" action="creationaventoursuite.php" method="post" role="form" style="display: block;">
                                    ...
                                    <h5>Donne un titre à ton aventour:</h5>

                                    
                                        <input type="text" name="title" id="title" tabindex="1" class="form-control" placeholder="Mon super titre!" value=<?php  echo "\"".$_SESSION['title']."\"";?>>
