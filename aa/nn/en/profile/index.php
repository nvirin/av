...
if(!((isset($_SESSION['myid'])&&file_exists($_SERVER['DOCUMENT_ROOT'].'/users/'.$_SESSION['myid'])))){
    //header('Location: signinregister/index.php');
      ...
      die('<html><meta http-equiv="Content-type" content="text/html; charset=utf-8" /><div class="col-md-12 center"><h1 style="text-align:center"><br><br>Hey, You have to sign in before reserving a tour =P <br><a href="http://www.aventour.net/en/signinregister/index.php">Sign in</a></h1></div></html');
    ...
    while ($donnees = $req->fetch())
{
    ...
    if(false/*!($idtour===$_GET['mytour'])*/){
          die('<html><meta http-equiv="Content-type" content="text/html; charset=utf-8" /><div class="col-md-12 center"><h1 style="text-align:center"><br><br>Ho, this tour does not exist =/ <br><a href="http://www.aventour.net/en/">Home page</a></h1></div></html');
...
$pathcouv='http://aventour.net/users/'.$mailhex.'/couverture.jpg';
...
<META NAME="DESCRIPTION" CONTENT="AvenTour, Tourism activities with people- profile">
...
">
    ...
    margin-top: 5px;
">
                        <?php include 'http://aventour.net/en/conectionoupas.php' ?>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
...
<div class="col-md-12">
                         <img src='http://aventour.net/users/<?php echo $mailhex; ?>/profile.jpg' alt="profile" class="img-responsive img-circle" style="
    max-width: 25%;" />
                         </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 text-center"> 
                    <div class="service-box">
                        ...
                        <h3>I speak, I manage or want to improve my:</h3>
                        <p class="text-muted">French</p>
                ...
                <div class="col-lg-6 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <p class="text-muted"><i class="fa fa-facebook-square fa-1x"></i>  <?php echo $nombrefbBD; ?> friends</p>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="portfolio-item">
                                <a href="#">
                                    <img class="img-portfolio img-responsive" src="http://aventour.net/images/bg/1.jpg">
                                </a>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="portfolio-item">
                                <a href="#">
                                    <img class="img-portfolio img-responsive" src="http://aventour.net/images/bg/3.jpg">
                                </a>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="portfolio-item">
                                <a href="#">
                                    <img class="img-portfolio img-responsive" src="http://aventour.net/images/bg/p1.jpg">
                                </a>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="portfolio-item">
                                <a href="#">
                                    <img class="img-portfolio img-responsive" src="http://aventour.net/images/bg/p2.jpg">
                                </a>
                            </div>
                        </div>
                    </div>
