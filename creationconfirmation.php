            ...
            <div class="col-md-12">
                <div class="panel panel-login">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <form id="login-form" action="creationaventourdescription.php" method="post" role="form" style="display: block;">
                                    ...
                                    <h5>Description:</h5>  
                                        ...
                                        <textarea type="text" rows="8" name="details" id="title" tabindex="1" class="form-control" placeholder="Ballade" value="">
<p>Exemple:<br /><br /><strong>Partez &agrave; la d&eacute;couverte NOCTURNE des &oelig;uvres du Louvre!&nbsp;</strong></p>
<p>Pour visiter tout le Louvre, il faudrait des semaines enti&egrave;res! Je vous propose d'admirer les 10 chefs d&rsquo;&oelig;uvres du Louvre en 2h: le radeau de la M&eacute;duse, La libert&eacute; guidant le peuple, la Joconde et bien d'autres...&nbsp; </p>
<p>Le + de la visite: Admirer ces &oelig;uvres aux heures inhabituelles d'ouverture du Mus&eacute;e.&nbsp;</p>
<p>Vous d&eacute;couvrirez &eacute;galement l'histoire du b&acirc;timent, son &eacute;volution au fil des si&egrave;cles du 12e au 19e si&egrave;cle. Comment cette forteresse du Louvre est devenue le Mus&eacute;e le plus connu du monde entier? Je vous montrerai la trace laiss&eacute;e par les diff&eacute;rents monarques et empereurs qui se sont succ&eacute;d&eacute;s.&nbsp;</p>
<p>&nbsp;</p>
                                        </textarea>
                                    ...
                                    <h5>Prerequis (Facultatif):</h5>  
                                        ...
                                        <textarea type="text" rows="8" name="prerequis" id="title" tabindex="1" class="form-control" placeholder="Ne pas oublier le parapluie," value=""><p>Exemple:<br /><br />N'oubliez pas votre carte d'identit&eacute;.</p></textarea>
