...
if(!((isset($_SESSION['myid'])&&file_exists($_SERVER['DOCUMENT_ROOT'].'/users/'.$_SESSION['myid'])))){
  ...
  die('<html><meta http-equiv="Content-type" content="text/html; charset=utf-8" /><div class="col-md-12 center"><h1 style="text-align:center"><br><br>Ha, Tu dois d\'abord te connecter pour créer un tour =/ <br><a href="http://aventour.net/en/signinregister/index.php">Se connecter</a></h1></div></html');
...
">
    ...
    margin-top: 5px;
">
                        <?php include '../en/conectionoupas.php' ?>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
    ...
    <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
            <div class="page-header">
                <!-- <h2>S'enregistrer</h2> -->
                <!-- Success message -->
<div class="alert alert-success hidden" role="alert" id="success_message"><i class="glyphicon glyphicon-thumbs-up"></i> Le lien d'activation a été envoyé sur ta boite mail. Tu pourras te connecter à ton compte: <a href="../en/signinregister/">Se connecter</a> </div>
...
<!-- Form Name -->
<legend>Mes versements</legend>

<!-- Text input-->
<p>Le versement se fera une fois que le tour sera effectué</p>
...
<div class="form-group">
  <label class="col-md-4 control-label">1. J'ai un compte paypal ou j'en créé un ici </label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <!-- <span class="input-group-addon"><i class="glyphicon glyphicon-ok"></i></span> -->
        <a href="https://www.paypal.com/fr/home" target="_blank">Ouvrir un compte paypal</a>
...
<div class="form-group">
  <label class="col-md-4 control-label">2. J'entre mon mail paypal</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
...
<div class="form-group">
  <label class="col-md-4 control-label"></label>  
    ...
    <div class="input-group">
        ...
        <h6>Bientot un autre moyen de recevoir ses versements (RIB)</h6>
