...
<!-- Form Name -->
<legend>ETAPE 1/2 </legend><br><h2>Lancement des premiers tours après le 1er mai</h2>
...
<div class="form-group">
 ...
 <!-- <input type="time" name="time" id="input-time" tabindex="1" class="form-control time" required placeholder="" value=<?php  echo "\"".$_SESSION['time']."\"";?>> -->
   <select id="duree" name="duree" class="form-control" value=<?php  echo "\"".$_SESSION['duree']."\"";?>>
                        ...
                        <option value="8">9 heures</option> 
                        <option value="8">10 heures</option> 
                        <option value="8">11 heures</option> 
                        <option value="8">12 heures</option>                      
