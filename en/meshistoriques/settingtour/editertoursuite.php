...
<!-- Form Name -->
<legend>Copier (et éditer) le tour:<br><p>Si vous ne voulez pas modifer un paramètre, il suffit de ne pas y toucher :)</p></legend><br><!-- <h2>Lancement des premiers tours après le 1er mai</h2> -->
...
$newDateString = $myDateTime->format('d/m/Y');
 ...
 <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
  ...
  <input type="text" class="form-control" name="datepicker" placeholder='<?php if(/*!empty($date_voyage)*/false){echo $newDateString;}else{echo '';} ?>' id="datepicker-13" name="datepicker" required>
    </div>
  </div>
</div>
<!-- <br> -->
