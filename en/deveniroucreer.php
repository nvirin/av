...
//header("Location: http://www.aventour.net/");
   echo '<li><a href="creationaventoursuite.php" class="btn" id="monCQuoi" style="outline: none;">Become an aventourer! <br> (Guide)

</a></li>';
}else{
	echo '<li><a href="" class="btn" data-toggle="modal" data-target="#project-11" id="monCQuoi">Create a tour!
  ...
  //$_SESSION['okphone']='ok';
	...
	echo '<li><a href="creationaventoursuite.php" class="btn" id="monCQuoi">Become an Aventourer! <br>(Guide)
