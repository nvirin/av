...
<head>
    <meta charset="utf-8">
    <title>Sign in to aventour.net- AvenTour</title>

    <META NAME="TITLE" CONTENT="AvenTour">
<META NAME="DESCRIPTION" CONTENT="Sign in to aventour.net- AvenTour">
...
<body class="no-trans" id="mybody">
    ...
    <button id="facebook">Sign in with Facebook</button>
                                ...
                                <!-- <div class="social-wrap a"> -->
                                <a id="myFb" href=<?php echo '"' . $loginUrl . '"'; ?> id=""></i>Sign in with Facebook</a>
                                <!-- </div>  -->
                    ...
                    <div class="panel-body">
                        <div class="row"> 
                        <div class="col-lg-12">
                                <h3 href="#" class="active" id="login-form-link">OR</h3>
                               <hr class="primary">
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="text-center">
                                                    <a href="mdp.php" tabindex="5" class="forgot-password">Password forgotten?</a>
                                                </div>
                                                <hr class="primary">
