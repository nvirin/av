...
if(!((string)$AncienDateString===(string)$myDateTime)){
 ...
 echo'<h3>Le '.$myDateTime.'</h3>';
    ...
    //$donnees['lv1']." ".$donnees['lv2']." ".$donnees['lv3']
    ...
    elseif($donnees['lv1']==='Autre'){$lv1='Other';}
    ...
    elseif($donnees['lv2']==='Autre'){$lv2='Other';}
    ...
    elseif($donnees['lv3']==='Autre'){$lv3='Other';}
                        ...
                        <div class=\"clearfix\"></div>
                                        ...
                                        if($reserver){echo"
                                         <div class=\"modal-footer\">
                                            <a href=\"reserver/index.php?mytrip=".$donnees['mailhexa']."&mytour=".$idtour."\" class=\"btn btn-sm btn-default\">Reserve it!</a>
                                        </div> ";}
                                        echo "
                                    </div>
                                </div>
