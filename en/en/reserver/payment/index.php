...
$req1 = $bdd->prepare("UPDATE `ma_base`.`voyage` SET `paypaltitle`=:paypaltitle, `paypalprix`=:paypalprix,`paypalfrais`=:paypalfrais,`paypaltoken`=:paypaltoken,`paypaltransactionid`=:paypaltransactionid, ,`mailvoyageur`=:mailvoyageur   WHERE idtour=:idtour");
    $req1->execute(array(
