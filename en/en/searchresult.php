...
<head>
	<meta charset="utf-8">
	<title>Result tourism activities: Paris, London, Reunion Island... - AvenTour</title>

	<META NAME="TITLE" CONTENT="AvenTour">
<META NAME="DESCRIPTION" CONTENT="AvenTour, results tourism activities with people">
<META NAME="KEYWORDS" CONTENT="Activities, tourism, people, adventures, traveling, discovering">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                   <!--  <li>
                    ...
                    <li>
                        <a href="http://aventour.net/en/creationaventoursuite.php">Create Tour</a>
                    </li>
                    <li style="
    margin-right: 10px;
    margin-top: 5px;
