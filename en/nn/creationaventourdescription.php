...
//si $_POST['go-submit']='Oui' (Ajouter plusieurs dates)  , aller en post su addtour.php et envoyer $setting ($setting=true num telephone etc pas rempli) ;
//si $_POST['go-submit']='Non' ou autres continuer la suite en elseif
$_SESSION['location']="";
$_SESSION['title']="";
$_SESSION['datepicker']="";
$_SESSION['time']="";
