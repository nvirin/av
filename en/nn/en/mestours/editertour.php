...
<div class="form-group">
 ...
 <!-- <input type="time" name="time" id="input-time" tabindex="1" class="form-control time" required placeholder="" value=<?php  echo "\"".$_SESSION['time']."\"";?>> -->
   <select id="duree" name="duree" class="form-control" value=<?php  echo "\"".$_SESSION['duree']."\"";?>>
                        ...
                        <option value="8">11 hours</option> 
...
<div class="col-xs-12">
  ...
  <input type="text" name="tag1" id="title" tabindex="1" class="form-control" placeholder="Ex: Ballad" value=<?php  echo "\"".$_SESSION['tag1']."\"";?> required> 
   <input type="text" name="tag2" id="title" tabindex="1" class="form-control" placeholder="Ex: Tastinf" value=<?php  echo "\"".$_SESSION['tag2']."\"";?> required>
