...
<form method="post" id="signup" class="form-inline margin-top sign-up-form validate formee" action="subscribe.php" target="_blank">							
								...
								<div class="mc-field-group">
									...
									<div class="inputGroupContainer">
										<div class="mc_embed_signup_scroll">
										 ...
										 <input name="subscribe" id="mc-embedded-subscribe" type="submit" value='Reçois les guides "Que faire à La Réunion et Que faire à Paris"' class="btn btn-primary">
										</div>
