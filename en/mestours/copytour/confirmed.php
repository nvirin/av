...
// var_dump($_POST);
$multidate = explode(",", $_POST['datepicker']);
// var_dump($multidate);
// print_r(count($multidate));
// foreach ($multidate as $cle => $valeur) {
//     //echo $cle.' - '.$valeur.'<br />'."\n";
//     $myDateTime=new \DateTime($valeur); 
...
//////////////////////////bouvcle
  ...
  $idtour2=str_replace(' ','',preg_replace("#[^a-zA-Z]#", "", $title)).substr(str_shuffle(strtolower(sha1(rand() . time() . "azertyuiopqsdfghjklmwxcvbn"))),0, 32);
 // $idtour2='Randonnmafate666651b';
  // var_dump($idtour2);
  // die;
