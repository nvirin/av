...
if(!((isset($_SESSION['myid'])&&file_exists($_SERVER['DOCUMENT_ROOT'].'/users/'.$_SESSION['myid'])))){ 
  ...
  //die();
  header('Location: http://www.aventour.net/en/connectetoi.html');
  die('<html><meta http-equiv="Content-type" content="text/html; charset=utf-8" /><div class="col-md-12 center"><h1 style="text-align:center"><br><br>Ha, Tu dois d\'abord te connecter =/ <br><a href="http://www.aventour.net/en/signinregister/index.php">Se connecter</a></h1></div></html');
...
//   $myDateTime=new \DateTime($donnees['date_voyage']); 
// //     //$myDateTime = DateTime::createFromFormat('d/m/Y', $valeur); 
// //     //$myDateTime = DateTime::createFromFormat('d/m/Y', $_POST['datepicker']);
//  $newDateString = $myDateTime->format('Y-m-d');
  $mesdates[]=$donnees['date_voyage'];
}

//var_dump($mesdates);die;
...
<title>Ajourter date tour</title>
...
<script type="text/javascript" src="http://www.aventour.net/dist/bootstrap-clockpicker.min.js"></script>
    ...
    <link href="http://code.jquery.com/ui/1.10.4/themes/ui-lightness/jquery-ui.css" rel="stylesheet">
      ...
      <script src="http://www.aventour.net/mestours/multidate/jquery-ui.multidatespicker.js"></script>
  ...
  <link href="http://www.aventour.net/css/simple-slider-volume.css" rel="stylesheet" type="text/css" />  
     ...
     <script>
 //var unavailableDates = ["2017-3-15", "2017-03-14", "2017-3-15"];
...
function unavailable(date) {
  ...
  // ymd = mm + "-" + dd + "-" + yyyy; 
    ...
    if ($.inArray(currentdate, unavailableDates) == -1) {
        return [true, ""];
    } else {
 ...
 // beforeShowDay: $.datepicker.unavailable
 // }
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="page-header">
                <!-- <h2>S'enregistrer</h2> -->
                <!-- Success message -->
<div class="alert alert-success hidden" role="alert" id="success_message"><i class="glyphicon glyphicon-thumbs-up"></i> Le lien d'activation a été envoyé sur ta boite mail. Tu pourras te connecter à ton compte: <a href="http://www.aventour.net/en/signinregister/">Se connecter</a> </div>
...
<!-- Form Name -->
<legend>Ajoutes quelques dates sur ce tour<br>Tu peux en séléctionner plusieurs!<p></p></legend><br><!-- <h2>Lancement des premiers tours après le 1er mai</h2> -->
...
<!-- Text input-->
  ...
  <label class="col-md-4 control-label">Lieu de départ du tour</label>  
    ...
    <div class="input-group">
      ...
      <input id="autocomplete" name="locationDeparture" class="form-control" placeholder='<?php if(!empty($locationDeparture)){echo $locationDeparture;}else{echo '';} ?>'
...
$newDateString = $myDateTime->format('d/m/Y');
    ...
    //echo '<u>Date actuelle:</u> '.$newDateString;
  } 
    ?>
  </p></div>
 ...
 <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
  ...
  <input type="text" class="form-control" placeholder='<?php if(/*!empty($date_voyage)*/false){echo $newDateString;}else{echo '';} ?>' id="datepicker-13" name="datepicker" required>
    </div>
  </div>
</div>
<!-- <br> -->
...
<!-- <div id="mysuccess"></div> -->
                                 ...
                                 <!--    <div class="form-group col-md-12 col-xs-12" > 
                                    <h5>Description:</h5>  <p><?php  if(!empty($details)){echo '<u>Ma description actuelle:</u><br>'.$details;} ?></p>
 ...
 -->
                                 <!--    <div class="form-group col-md-12 col-xs-12" > 
                                     ...
                                     <p><?php  if(!empty($prerequis)){echo '<u>Mes prerequis actuel:</u><br>'.$prerequis;} ?></p>
