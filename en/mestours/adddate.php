...
<div class="col-xs-12">
    ...
    <button class="add_field_button btn btn-default">Ajouter date</button>
    </div>
    <div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
   ...
   <a class="btn btn-warning" href="../mestours">Retour</a>
  </div>
</div>
    ...
    $(add_button).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
         ...
         // });
            ...
            $(wrapper).append('<div><hr><div class="form-group"><label class="col-md-4 control-label" >Quand (jj/mm/aaaa)?</label><div class="col-md-4 inputGroupContainer"><div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span><input required type="text" class="form-control hasDatepicker"  placeholder="Ex: 31/12/2018" id="datepicker-13" name="datepicker[]"/></div></div></div><a href="#" class="remove_field">Remove</a></div>'); //add input box
        }
    });
