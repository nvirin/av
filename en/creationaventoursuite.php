...
$reqdate->execute(array($mailstring));
...
<div class="form-group">
 ...
 <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
  ...
  <input type="text" class="form-control"  placeholder="Quand ?" id="datepicker-13" name="datepicker" value=<?php  echo "\"".$_SESSION['datepicker']."\"";?> required >
    ...
    Pour ajouter plusieurs dates une fois terminé: <strong>Acceuil-><?php echo $prenom ?>->Mes Tours->Ajouter dates</strong> 
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label">Heure</label>  
    ...
    <input type="text" name="time" id="input-time" tabindex="1" class="timepicker form-control time" value=<?php  echo "\"".$_SESSION['time']."\"";?>>
...
<div class="col-xs-12">
  ...
  <label class="hidden col-md-4 control-label">Minimum</label>  
    <div class="hidden col-md-4 inputGroupContainer">
    <div class="hidden input-group">
        <span class="hidden input-group-addon"><i class="hidden glyphicon glyphicon-user"></i></span>
  <select id="minimum" name="minimum" class="hidden form-control" value=<?php  echo "\"".$_SESSION['minimum']."\"";?>>
