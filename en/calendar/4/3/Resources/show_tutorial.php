    	...
    	<table class="hack-ie"><tr valign="top">
            ...
            <td class="content-R">
             <div id="main-content">
                ...
                <div id="middle">
                	<div id="main">
                		<div class="component-title fix-float"><span class="left"><img src="<?php echo $controlImgUrl; ?>/icon.png" align="absbottom" /><?php echo $docs["title"];?></span></div>
						
                    	<?php echo $docs["content"];?>
                	</div>
                </div>
