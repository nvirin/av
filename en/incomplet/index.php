...
// if(!isset($_SESSION['myid'])){
//   header("location:  http://aventour.net/incomplet/");
...
if(!((isset($_SESSION['myid'])&&file_exists($_SERVER['DOCUMENT_ROOT'].'/users/'.$_SESSION['myid'])))){ 
  ...
  die('<html><meta http-equiv="Content-type" content="text/html; charset=utf-8" /><div class="col-md-12 center"><h1 style="text-align:center"><br><br>Profil incomplet,<br><br> Reconnecte toi et autorise nous à avoir accès à ton email <br>(Lors de la connection viaFacebook)<br><a href="http://aventour.net/en/signinregister/index.php">Se connecter</a></h1></div></html');
