...
<form method="post" id="signup" class="validate formee" action="subscribe.php" target="_blank">							
								...
								<!-- Form Name -->
								<legend>Guide "What to do in Paris- in Reunion Island" (Beta)</legend> 
								<h5 class="text-muted">Just tell me  where I can send it!</h5> 
			...
			<div class="row">
								...
								<div class="col-md-12 form-group clear" id="mce-responses" >
									...
									<div class="col-md-4">
										...
										<button type="submit" value="Subscribe" class="btn btn-primary clear" name="subscribe" id="mc-embedded-subscribe">Get our guide<span class="glyphicon glyphicon-send"></span></button>
									</div>
								</div>
