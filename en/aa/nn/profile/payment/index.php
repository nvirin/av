...
$products = array(
	array(
		"name" => 'Aventour - x '.$_nombretouriste.', '.$title.', '.$lieu.', '.$date,
		"price"=> $_total,
		"priceTVA" => $_total,
		"count"=> 1
	),
...
$total = $_total; 
$totalttc = $_total;
$port = ceil($totalttc*0.25);  
$paypal = "#"; 
$paypal = new Paypal();
$params = array(
	'RETURNURL' => 'http://www.aventour.io/reserver/payment/process.php',
	'CANCELURL' => 'http://www.aventour.io/reserver/payment/cancel.php',
...
$req1 = $bdd->prepare("UPDATE `ma_base`.`voyage` SET `paypaltitle`=:paypaltitle, `paypalprix`=:paypalprix,`paypalfrais`=:paypalfrais,`paypaltoken`=:paypaltoken,`paypaltransactionid`=:paypaltransactionid  WHERE idtour=:idtour");
    $req1->execute(array(
