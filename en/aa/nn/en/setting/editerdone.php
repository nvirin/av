...
if(!((isset($_SESSION['myid'])&&file_exists($_SERVER['DOCUMENT_ROOT'].'/users/'.$_SESSION['myid'])))){
  ...
  die('<html><meta http-equiv="Content-type" content="text/html; charset=utf-8" /><div class="col-md-12 center"><h1 style="text-align:center"><br><br>Hey, you have to sign in before creating a tour =/ <br><a href="http://aventour.net/en/signinregister/">Sign in</a></h1></div></html');
...
{
     $erreur = 'Except for the cover picture: You have to upload an .jpg';
}
if($taille>$taille_maxi)
{
     $erreur = 'Except for the cover picture:: The picture is too big...';
}
if(!isset($erreur)){
     ...
     else //Sinon (la fonction renvoie FALSE).
     {
      ...
      $erreur = 'Failure: Cover picture unuploaded!';
     }
...
//header('Location: http://aventour.io/myindexdev.php');
  die('<html><meta http-equiv="Content-type" content="text/html; charset=utf-8" /><div class="col-md-12 center"><h1 style="text-align:center"><br><br>Edition terminé <br>'.$erreur.'<br><a href="http://aventour.net/en/mesversement/">Keep going on</a></h1></div></html');
...
//echo'coucou0 '.$mailstring;
	...
	//header('Location: http://aventour.io/myindexdev.php');
  die('<html><meta http-equiv="Content-type" content="text/html; charset=utf-8" /><div class="col-md-12 center"><h1 style="text-align:center"><br><br>Edition done <br>'.$erreur.'<br><a href="http://aventour.net/en/mesversement">Keep going on</a></h1></div></html');
	//echo'coucou1 ';
