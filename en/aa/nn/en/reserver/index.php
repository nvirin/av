...
if(!((isset($_SESSION['myid'])&&file_exists($_SERVER['DOCUMENT_ROOT'].'/users/'.$_SESSION['myid'])))){
    //header('Location: signinregister/index.php');
      ...
      die('<html><meta http-equiv="Content-type" content="text/html; charset=utf-8" /><div class="col-md-12 center"><h1 style="text-align:center"><br><br>Hey, you have to sign up before reserving a tour =P <br><a href="http://www.aventour.net/en/signinregister/index.php">Sign in</a></h1></div></html');
    ...
    while ($donnees = $req->fetch())
{
    ...
    if(!($idtour===$_GET['mytour'])){
          die('<html><meta http-equiv="Content-type" content="text/html; charset=utf-8" /><div class="col-md-12 center"><h1 style="text-align:center"><br><br>oops, this tour does not exist =/ <br><a href="http://www.aventour.net/en/">Home page</a></h1></div></html');
...
"><?php echo $_prix; ?> €</h1><p style="
    color: white;
">Group <?php echo $_min; ?>-<?php echo $_max; ?> people + <?php echo $_prixsupp; ?> € /additional person</p>
...
<!-- <div class="alert alert-success hidden" role="alert" id="success_message"><i class="glyphicon glyphicon-thumbs-up"></i> Le lien d'activation a été envoyé sur ta boite mail. Tu pourras te connecter à ton compte: <a href="../signinregister/">Se connecter</a> </div> -->
            ...
            <form class="well form-horizontal" method="post"  id="defaultForm" action="http://www.aventour.net/en/reserver/payment/index.php">
<fieldset>

<!-- Form Name -->
<legend><?php echo $_prix; ?> € /group of <?php echo $_min; ?> to <?php echo $_max; ?> people</legend><br>
<h5>+ <?php echo $_prixsupp; ?> € /additional person</h5>
<h5 id="total"></h5>
<div class="prix"><p><span></span> €</p></div>
<div class="frais"><p>taxes: <span></span> €</p></div>
...
<div class="form-group">
  <label class="col-md-4 control-label"></label>
  <div class="col-md-4">
    <button type="submit" name="submit" class="btn btn-warning" >Reserve it! <br>(Paypal or Visa via Paypal) <span class="glyphicon glyphicon-send"></span></button>
  ...
  <!--   <aside class="call-to-action bg-primary">
   ...
   $('.prix span').text(nombretouriste+" Tourists: "+_total);
