...
<head>
    <meta charset="utf-8">
    <title>Confirmation creation of your activity - AvenTour</title>

    <META NAME="TITLE" CONTENT="AvenTour">
<META NAME="DESCRIPTION" CONTENT="Confirmation creation of your activity - AvenTour">
                            ...
                            <div class="col-lg-12">
                                <form id="login-form" action="creationaventourdescription.php" method="post" role="form" style="display: block;">
                                    ...
                                    <h5>Description:</h5>  
                                        ...
                                        <textarea type="text" rows="8" name="details" id="title" tabindex="1" class="form-control" placeholder="Let explain some details of your activity (What? how?...)" value=""></textarea>
