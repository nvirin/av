...
<html>
  <head>
    ...
    <title>Se connecter à stripe</title>
   ...
   <!--    <div id="get-started" tabindex="-1" role="dialog" aria-labelledby="Login" aria-hidden="true" class="modal fade">
      ...
      <section id="intro" class="text-intro">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h1>Créer compte affiliation aventour.net (stripe)</h1>
...
Dites moi seulement à quelle adresse je dois vous l'envoyer ! -->
 ...
 <input type="text" class="form-control" id="" name="fname" placeholder="Prenom*" required>
    </div>
      <div class="form-group col-md-6">
 <input type="text" class="form-control" id="" name="lname" placeholder="Nom*" required>
    </div>
     <div class="form-group"> 
    ...
    <div class="form-group">
 <input type="text" class="form-control" id="" name="website" placeholder="Site web*" required>
    </div>

     <div class="form-group">
        <label for="inputPassword">Autres supports</label> 
  
           <textarea class="form-control" rows="5" id="comment" name="support" placeholder="facebook, twitter,..."></textarea>
    </div>
  
    <div class="form-group col-md-12">
    	 <label> </label>
    <button type="submit" class="btn btn-lg btn-block btn-primary">Créer compte affiliation (Stripe)</button>
