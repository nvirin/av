		...
		<div id="page" class="hfeed site">
		    ...
		    <div id="masthead-wrap">
				...
				<header id="masthead" class="site-header header_container" role="banner">
					...
					<?php if ( get_theme_mod( 'discovery_logo' ) ) : ?>

						<div class="site-logo">
							<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img src="<?php echo esc_url( get_theme_mod( 'discovery_logo' ) ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>"></a>
						</div>
