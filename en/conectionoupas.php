...
if(isset($_SESSION['myid'])&&file_exists($_SERVER['DOCUMENT_ROOT'].'/users/'.$_SESSION['myid'])){
  ...
  if(empty($phonenumber1)){
   header("Location: http://www.aventour.net/en/phone/");
...
//$mapresentation=$result['mapresentation'];
   ...
   $fname=$jsondec['first_name'];
    ...
    <ul class="dropdown-menu" style="background-color: white;"> 
     ...
     <!-- <li>
        <a href="../en/profile/"><i class="fa fa-fw fa-user"></i> Profile</a>
      </li>-->
      <li>
        <a href="../en/setting/"><i class="fa fa-fw fa-gear"></i> Edit Profile</a>
      </li>
     <!-- <li>
        <a href="../en/mesversement/"><i class="fa fa-fw fa-eur"></i> Mes versements</a>
      </li>-->
      <li>
        <a href="../en/mestours/"><i class="fa fa-fw fa-bicycle"></i > My Tours</a>
      </li>';

      // if($checkAventourer000){

      //   echo'
      //   <li>
      //   <a href="../meshistoriques/"><i class="fa fa-fw fa-clock-o"></i > Historiques</a>
      // </li>';
      ...
      <li class="divider"></li>
      <li>
        <a href="../en/signout4.php"><i class="fa fa-fw fa-power-off"></i> Sign out</a>
      </li>
    </ul>
  </div>';
 ...
 //  </li></ul>";
	...
	echo '<li class="active"><a href="signinregister" class="btn" id="monConectInscris">Sign in</a></li>';
 }
 ?> 
