...
echo '<h1 class="" style="
    padding-top: 1em;
    padding-bottom: 1em;
"> Quelques tours de nos aventoureurs...</h1>';

 mResult('reunion','L\'Ile de la Réunion, l\'Ile Intense!<br> (Voir plus...)',$bdd);
 mResult('paris','Paris, la ville lumière! <br> (Voir plus...)',$bdd);
